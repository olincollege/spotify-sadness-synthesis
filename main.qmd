...
# mitski_rank = get_avg_ranking(mitski_df, 5)
# graph_songs_percentile(mitski_rank, "Mitski Percentiles", 30)

# phoebe_rank = get_avg_ranking(phoebe_df, 5)
...
stranger_in_the_alps = make_dict_one_album(sita, phoebe_rank)
punisher1 = make_dict_one_album(punisher, phoebe_rank)
be_the_cowboy = make_dict_one_album(btc, mitski_rank)
puberty_2 = make_dict_one_album(p2, mitski_rank)

graph_songs_percentile(stranger_in_the_alps, "Stranger in the alps", 40)
graph_songs_percentile(punisher1, "Punisher", 40)
graph_songs_percentile(be_the_cowboy, "Be The Cowboy", 40)
graph_songs_percentile(puberty_2, "Puberty 2", 40)
```
